...
from models.es_types import JobboleArticleType, LagouArticleType
...
class JobBoleArticleItem(scrapy.Item):
    ...
    def save_to_es(self):
        ...
        article.suggest = gen_suggests(JobboleArticleType._doc_type.index, ((article.title, 10), (article.tags, 7)))
...
class LagouJobItem(scrapy.Item):
    ...
    def save_to_es(self):
        ...
        article.suggest = gen_suggests(LagouArticleType._doc_type.index, ((article.title, 10), (article.tags, 7)))
